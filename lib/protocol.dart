...
BigInt olderDecodeBigInt(List<int> bytes) {
...
BigInt deserializeMpInt(SerializableInput input) =>
    olderDecodeBigInt(deserializeStringBytes(input));
...
class MSG_CHANNEL_REQUEST extends SSHMessage {
  ...
  MSG_CHANNEL_REQUEST.ptyReq(this.recipientChannel, this.requestType, Point d,
      ...
      : width = d.x as int?,
        ...
        super(ID);
  MSG_CHANNEL_REQUEST.env(
      this.recipientChannel, this.requestType, this.wantReply, this.varName, this.varValue)
      : super(ID);

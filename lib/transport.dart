...
typedef Uint8ListFunction = Future<Uint8List> Function();
...
abstract class SSHTransport with SSHDiffieHellman {
  ...
  void handleMSG_CHANNEL_OPEN_CONFIRMATION(MSG_CHANNEL_OPEN_CONFIRMATION msg) {
    ...
    if(msg.senderChannel != null){
      chan.remoteId = msg.senderChannel as int;
    }
    if(msg.initialWinSize != null){
      chan.windowC = msg.initialWinSize as int;
    }
  ...
  Channel acceptChannel(MSG_CHANNEL_OPEN msg) {
    ...
    if(msg.senderChannel != null){
      channel.remoteId = msg.senderChannel as int;
    }
    if(msg.initialWinSize != null){
      channel.windowC = msg.initialWinSize as int;
    }
